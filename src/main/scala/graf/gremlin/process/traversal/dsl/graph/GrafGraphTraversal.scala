...
class GrafGraphTraversal[Start, End](private[graph] val graphTraversal: GraphTraversal[Start, End]) extends GrafTraversal[Start, End](graphTraversal) {
  ...
  def by[V](element: Element ⇒ V, comparator: (V, V) ⇒ Int): GrafGraphTraversal[Start, End] =
  ...
  def emit(emitPredicate: GrafTraverser[End] ⇒ Boolean): GrafGraphTraversal[Start, End] =
    graphTraversal.emit((e: Traverser[End]) ⇒ emitPredicate(toGrafTraverser(e)))
  ...
  def by[V](traversal: GrafTraversal[_, _], endComparator: (V, V) ⇒ Int): GrafGraphTraversal[Start, End] =
  ...
  def by(comparator: (End, End) ⇒ Int): GrafGraphTraversal[Start, End] =
  ...
  def sideEffect(consumer: GrafTraverser[End] ⇒ Unit): GrafGraphTraversal[Start, End] =
    graphTraversal.sideEffect(consumer)

  def branch[M, E2](f: GrafTraverser[End] ⇒ M): GrafGraphTraversal[Start, E2] =
    graphTraversal.branch((t: Traverser[End]) ⇒ f(t)).asInstanceOf[GraphTraversal[Start, E2]]

  def path: GrafGraphTraversal[Start, Path] =
    graphTraversal.path()

  def by[V](elementPropertyProjection: String, propertyValueComparator: (V, V) ⇒ Int): GrafGraphTraversal[Start, End] =
  ...
  def until(until: GrafTraverser[End] ⇒ Boolean): GrafGraphTraversal[Start, End] =
