...
import graf.gremlin.structure.schema.{ ID, KeyValue, Label }
import org.apache.tinkerpop.gremlin.process.traversal.P

class GrafElementGraphTraversal[Start <: GrafElement, End <: GrafElement](private[graph] override val graphTraversal: GraphTraversal[Start, End]) extends GrafGraphTraversal(graphTraversal) {
